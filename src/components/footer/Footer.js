      ...
      <div class="col-4 offset-1">
        <form>
          ...
          <div class="d-flex w-100 gap-2">
            ...
            <input id="newsletter1" type="text" class="form-control" placeholder="Email address" fdprocessedid="xa1qu9"/>
            <button class="btn btn-primary" type="button" fdprocessedid="aiy3qj">Subscribe</button>
          </div>
        </form>
      </div>
    </div>

    <div style={{ backgroundColor:"#669C8F" }}>
      <h4 className='text-light text-center pt-4'>© 2021 Company, Inc. All rights reserved.</h4>
